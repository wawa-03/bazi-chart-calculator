...
export default function AccountPage() {
  ...
  return (
    <ProductPage>
      ...
      {isReviewer && <section className="reviewer-entry"><div><span>REVIEWER ACCESS</span><h2>命理师工作台</h2><p>只查看用户主动提交的档案；在此复核格局、从格和特殊合化，并维护规则文案版本。</p></div><Link href="/review-desk">进入工作台 <ChevronRight /></Link></section>}
