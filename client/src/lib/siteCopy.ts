...
export const siteCopy: Record<ManualLocale, SiteCopy> = {
  "zh-CN": {
    ...
    city: { label: "出生城市", ready: "可搜索全球城市", connecting: "正在连接地点服务", placeholder: "输入城市，如北京、London、Tokyo", clear: "清除城市", searching: "正在搜索", results: "城市搜索结果", selected: "已选" },
  },
  "zh-TW": {
    ...
    city: { label: "出生城市", ready: "可搜尋全球城市", connecting: "正在連線地點服務", placeholder: "輸入城市，如北京、London、Tokyo", clear: "清除城市", searching: "正在搜尋", results: "城市搜尋結果", selected: "已選" },
  },
  en: {
    ...
    city: { label: "Birth city", ready: "Search cities worldwide", connecting: "Connecting to place service", placeholder: "Search a city, e.g. Beijing, London, Tokyo", clear: "Clear city", searching: "Searching", results: "City search results", selected: "Selected" },
  },
};
